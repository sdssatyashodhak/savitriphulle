 ...
 */
public class HrailwayRequest extends StringRequest {

    private static final String REGISTER_REQUEST_URL ="http://vjtiorc.freeiz.com/ahcrconnection.php";
    private Map<String,String> params;

    public HrailwayRequest(int id, String starting_station , String DOB, String ticket, String pclass, String pestation, String vovno, String estation, String period,
