...
public class Wregistration extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bregister.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v){
                ...
                Response.Listener<String> responseListener= new Response.Listener<String>() {
                    public void onResponse(String response) {
                        try {
                            ...
                            if(success){
                                Intent intent= new Intent(Wregistration.this,Login.class);
                                Wregistration.this.startActivity(intent);
                            }else {
                                AlertDialog.Builder builder= new AlertDialog.Builder(Wregistration.this);
                ...
                WregisterRequest registerRequest=new WregisterRequest(fullname,id,pass,course,date,month,year,add,gender,cast,from,phon,email,ans,responseListener);
                RequestQueue queue= Volley.newRequestQueue(Wregistration.this);
