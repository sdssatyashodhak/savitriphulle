...
public class Wrailwayform extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.wrailwayform);
        ...
        bsubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v){
                ...
                Response.Listener<String> responseListener= new Response.Listener<String>() {
                    public void onResponse(String response) {
                        try {
                            ...
                            if(success){
                                Intent intent= new Intent(Wrailwayform.this,Wlogin.class);
                                Wrailwayform.this.startActivity(intent);
                            }else {
                                AlertDialog.Builder builder= new AlertDialog.Builder(Wrailwayform.this);
                ...
                WrailwayRequest formRequest=new WrailwayRequest(id,starting_station,DOB,ticket,pclass,pestation,estation,period,cclass,sdate,smonth,syear,edate,emonth,
                        eyear,responseListener);
                RequestQueue queue= Volley.newRequestQueue(Wrailwayform.this);
