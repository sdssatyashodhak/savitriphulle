...
public class Railwayform extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bsubmit.setOnClickListener(new View.OnClickListener() {
                ...
                Response.Listener<String> responseListener= new Response.Listener<String>() {
                    public void onResponse(String response) {
                        try {
                            ...
                            if(success){
                                Intent intent= new Intent(Railwayform.this,Login.class);
                                Railwayform.this.startActivity(intent);
                            }else {
                                AlertDialog.Builder builder= new AlertDialog.Builder(Railwayform.this);
            ...
            RequestQueue queue= Volley.newRequestQueue(Railwayform.this);
