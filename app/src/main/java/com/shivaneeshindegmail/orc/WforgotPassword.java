...
public class WforgotPassword extends AppCompatActivity {
    public void onCreate(Bundle savedInstanceState){
        ...
        bSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v){
                ...
                Response.Listener<String> responseListener= new Response.Listener<String>() {
                    public void onResponse(String response) {
                        try {
                            ...
                            if(success){
                                Intent intent= new Intent(WforgotPassword.this,Wlogin.class);
                                WforgotPassword.this.startActivity(intent);
                            }else {
                                AlertDialog.Builder builder= new AlertDialog.Builder(WforgotPassword.this);
                ...
                WforgotRequest forgotRequest=new WforgotRequest(id,ans,npass,responseListener);
                RequestQueue queue= Volley.newRequestQueue(WforgotPassword.this);
