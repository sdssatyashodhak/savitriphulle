...
public class Hregistration extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bregister.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v){
                ...
                Response.Listener<String> responseListener= new Response.Listener<String>() {
                    public void onResponse(String response) {
                        try {
                            ...
                            if(success){
                                Intent intent= new Intent(Hregistration.this,Login.class);
                                Hregistration.this.startActivity(intent);
                            }else {
                                AlertDialog.Builder builder= new AlertDialog.Builder(Hregistration.this);
                ...
                HregisterRequest registerRequest=new HregisterRequest(fullname,id,pass,course,date,month,year,add,gender,cast,from,phon,email,ans,responseListener);
                RequestQueue queue= Volley.newRequestQueue(Hregistration.this);
